...
/***/ function(module, exports, __webpack_require__) {
	...
	window.fetch = _giphy_actions.fetchSearchGiphys;
	window.receive = _giphy_actions.receiveSearchGiphys;
...
/***/ function(module, exports, __webpack_require__) {
	...
	var fetchSearchGiphys = exports.fetchSearchGiphys = function fetchSearchGiphys(searchTerm, num) {
	    return function (dispatch) {
	        APIUtil.fetchSearchGiphys(searchTerm, num).then(function (giphys) {
...
/***/ function(module, exports, __webpack_require__) {
	...
	var mapDispatchToProps = function mapDispatchToProps(dispatch) {
	  return { fetchSearchGiphys: function fetchSearchGiphys(searchTerm, num) {
	      return dispatch((0, _giphy_actions.fetchSearchGiphys)(searchTerm, num));
	    } };
	};
...
/***/ function(module, exports, __webpack_require__) {
	...
	var GiphysSearch = function (_Component) {
	  ...
	  _createClass(GiphysSearch, [{
	    ...
	    key: 'handleChange2',
	    value: function handleChange2(e2) {
	    ...
	    value: function render() {
	      ...
	      return _react2.default.createElement(
	        ...
	        _react2.default.createElement(
	          ...
	          _react2.default.createElement('input', { value: this.state.num, onChange: this.handleChange2 }),
	          _react2.default.createElement('br', null),
	          _react2.default.createElement('br', null),
	          _react2.default.createElement(
	            'button',
